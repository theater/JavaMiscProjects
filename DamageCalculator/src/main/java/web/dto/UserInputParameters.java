...
public class UserInputParameters {
    ...
    public String toString() {
        return "UserInputParameters [castleLevel=" + castleLevel + ", troopsAmount=" + troopsAmount + ", useMarchCapacityBoost=" + useMarchCapacityBoost + ", useMarchCapacitySpell=" +
                useMarchCapacitySpell + ", maxTier=" + maxTier + ", troopAttack=" + troopAttack + ", troopDefense=" + troopDefense + ", troopHealth=" + troopHealth + ", infantryAttack=" +
                infantryAttack + ", infantryDefense=" + infantryDefense + ", infantryHealth=" + infantryHealth + ", cavalryAttack=" + cavalryAttack + ", cavalryDefense=" + cavalryDefense +
                ", cavalryHealth=" + cavalryHealth + ", distanceAttack=" + distanceAttack + ", distanceDefense=" + distanceDefense + ", distanceHealth=" + distanceHealth + ", artilleryAttack=" +
                artilleryAttack + ", artilleryDefense=" + artilleryDefense + ", artilleryHealth=" + artilleryHealth + ", troopDamage=" + troopDamage + ", infantryDamage=" + infantryDamage +
                ", cavalryDamage=" + cavalryDamage + ", distanceDamage=" + distanceDamage + ", artilleryDamage=" + artilleryDamage + ", troopDamageReduction=" + troopDamageReduction +
                ", infantryDamageReduction=" + infantryDamageReduction + ", cavalryDamageReduction=" + cavalryDamageReduction + ", distanceDamageReduction=" + distanceDamageReduction +
                ", artilleryDamageReduction=" + artilleryDamageReduction + ", distanceVsInfantryDamage=" + distanceVsInfantryDamage + ", distanceVsCavalryDamage=" + distanceVsCavalryDamage +
                ", distanceVsArtilleryDamage=" + distanceVsArtilleryDamage + ", cavalryVsInfantryDamage=" + cavalryVsInfantryDamage + ", cavalryVsDistanceDamage=" + cavalryVsDistanceDamage +
                ", cavalryVsArtilleryDamage=" + cavalryVsArtilleryDamage + ", infantryVsDistanceDamageReduction=" + infantryVsDistanceDamageReduction + ", infantryVsCavalryDamageReduction=" +
                infantryVsCavalryDamageReduction + ", infantryVsArtilleryDamageReduction=" + infantryVsArtilleryDamageReduction + ", army=" + army + "]";
    }
